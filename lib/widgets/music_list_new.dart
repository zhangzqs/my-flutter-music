                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: webdavProvider.isRecursiveScanning 
                          ? null 
                          : () => webdavProvider.scanAllMusicFiles(),
                      icon: webdavProvider.isRecursiveScanning
                          ? const SizedBox(
                              width: 16,
                              height: 16,
                      ...
                      label: Text(webdavProvider.isRecursiveScanning 
                          ? '扫描中...' 
                          : '递归扫描'),
                    ),
                  ),
                  ...
                  // 刷新当前文件夹按钮
                  ElevatedButton.icon(
                    onPressed: webdavProvider.isLoading 
                        ? null 
